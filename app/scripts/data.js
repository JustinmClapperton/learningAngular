...
var dataStruct = [
    ...
    ["LinkButton", "bluetoothLink", "AdvancedMenu", "Bluetooth",0,0,0,0, "#bluetoothMenu"],
    ["LinkButton", "filesLink", "AdvancedMenu", "Files",0,0,0,0, "#filesMenu"],
    ["LinkButton", "utilityLink", "AdvancedMenu", "Utility",0,0,0,0, "#utilityMenu"],
    ["LinkButton", "pilotInputLink", "AdvancedMenu", "Pilot Inputs",0,0,0,0, "#pilotInputsMenu"],
    ["LinkButton", "gyroSensesLink", "AdvancedMenu", "Gyro Senses",0,0,0,0, "#gyroSensesMenu"],
    ["LinkButton", "gpsDataLink", "AdvancedMenu", "GPS Data",0,0,0,0, "#gpsDataMenu"],
    ["LinkButton", "recieverLink", "AdvancedMenu", "Reciever",0,0,0,0, "#recieverMenu"],
    ["LinkButton", "orientationLink", "AdvancedMenu", "Orientation",0,0,0,0, "#orientationMenu"],
    ["LinkButton", "controlLink", "AdvancedMenu", "Control",0,0,0,0, "#controlMenu"],
    ["LinkButton", "driveSystemLink", "AdvancedMenu", "DriveSystem",0,0,0,0, "#driveSystemMenu"],
    ["LinkButton", "govSettingsLink", "AdvancedMenu", "Gov Settings",0,0,0,0, "#govSettingsMenu"],
    ["LinkButton", "gpsSettingsLink", "AdvancedMenu", "GPS Settings",0,0,0,0, "#gpsSettingsMenu"],
    ["LinkButton", "swashMixingLink", "AdvancedMenu", "Swash Mixing",0,0,0,0, "#swashMixingMenu"],
    ["LinkButton", "swashServoLink", "AdvancedMenu", "Swash Servo",0,0,0,0, "#swashServoMenu"],
    ["LinkButton", "tailServoLink", "AdvancedMenu", "Tail Servo",0,0,0,0, "#tailServoMenu"],
    ["LinkButton", "cycBank1Link", "AdvancedMenu", "Cyc Bank 1",0,0,0,0, "#cycBank1Menu"],
    ["LinkButton", "cycBank2Link", "AdvancedMenu", "Cyc Bank 2",0,0,0,0, "#cycBank2Menu"],
    ["LinkButton", "tailBank1Link", "AdvancedMenu", "Tail Bank 1",0,0,0,0, "#tailBank1Menu"],
    ["LinkButton", "tailBank2Link", "AdvancedMenu", "Tail Bank 2",0,0,0,0, "#tailBank2Menu"],
